...
public class FrmMain extends JFrame implements ActionListener {
    ...
    private JMenuItem  menuItem_DeletePlan=new JMenuItem("删除计划");//计划管理
    ...
    private JMenuItem  menuItem_moveDownStep=new JMenuItem("步骤下移");//步骤管理

    private JMenuItem  menuItem_static1=new JMenuItem("统计1");//查询统计
    
    private JMenuItem  menuItem_modifyPwd=new JMenuItem("密码修改");//更多
